...
import com.gabilheri.moviestmdb.ui.main.MovieRow;
...
public class MainFragment extends BrowseSupportFragment implements OnItemViewSelectedListener {
    ...
    private void fetchNowPlayingMovies() {
        mDbAPI.getNowPlayingMovies(Config.LOGD, mRows.get(NOW_PLAYING).getPage())
    ...
    private void fetchPopularMovies() {
        mDbAPI.getPopularMovies(Config.LOGD, mRows.get(POPULAR).getPage())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(response -> {
    ...
    private void fetchUpcomingMovies() {
        mDbAPI.getUpcomingMovies(Config.LOGD, mRows.get(UPCOMING).getPage())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(response -> {
    ...
    private void fetchTopRatedMovies() {
        mDbAPI.getTopRatedMovies(Config.LOGD, mRows.get(TOP_RATED).getPage())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(response -> {
